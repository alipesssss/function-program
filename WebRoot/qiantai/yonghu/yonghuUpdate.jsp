...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer770">
					...
					<div class="Slot">
                <form name="formAdd" method="post" action="<%=path %>/user?type=userUpdate">
                                  <div class="c1-bline" style="padding:7px 0px;">
                                       <div class="f-left" style="margin-left: 5px;">
                                                   用户账号：<input style="width: 200px;" name="zhanghao"  value="${sessionScope.user.zhanghao}"  type="text" />
                                       </div>
                                    ...
                                    <div class="c1-bline" style="padding:7px 0px;">
                                       ...
                                       <input type="hidden" name="id" value="${sessionScope.user.id}"/>
                                        <input type="submit" value="修改" style="width: 100px;height: 24px;"/>
                                       </div>
                                       <div class="f-right"></div>
                                       <div class="clear"></div>
                                  </div>
