...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
  <TR>
    <TD width=10><IMG src="<%=path %>/admin/images/new_001.jpg" border=0></TD>
    <TD background="<%=path %>/admin/images/new_002.jpg"><FONT size=4><B>垃圾分类积分兑换系统      超级管理员模块
      </B></FONT> </TD>
    <TD background="<%=path %>/admin/images/new_002.jpg">
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
    ...
    <TD width=10><IMG src="<%=path %>/admin/images/new_003.jpg" 
